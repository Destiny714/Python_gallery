...
# 商品h5页面链接
aim_url = 'https://h5.youzan.com/wscgoods/tee-app/detail.json?app_id=wxdcc11cd7703c0e8d&kdt_id=44077958&access_token=f2d8e81ba7ef21954ae5e5df14dd9d&alias=2fmshg9oszz1i&bannerId=f.83554713~goods.8~0~2bwsuDp5&banner_id=f.83554713~goods.8~0~ufa6zRkw&slg=undefined&oid=0&scene=1001&ump_alias=&ump_type=&activityId=&activityType=&subKdtId=0&notQueryVoucher=1'

# 用户sid列表
sid_list = [
    'YZ950877537612189697YZMTQtYZ3d'
]
...
kdt_id = re.findall(r'kdt_id=(\d+?)&', aim_url)[0]  # 自动读取商户kdtid
...
def header(sid):
    headers = {
        ...
        'Extra-Data': '{"sid":"%s","clientType":"weapp-miniprogram","version":"2.97.3","client":"weapp","bizEnv":"wsc"}' % sid,
